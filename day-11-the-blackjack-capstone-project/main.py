...
def calculate_score(list_cards):
	...
	if score > 21 and 11 in list_cards:
...
def check(user_score, computer_score):
	...
	if user_score ==  0:
		print("Win with a Blackjack.")
		print(f"Computer's cards: {computer_cards}, computer's current score: {computer_score}")
...
while game_flag:
	...
	check(user_cards, computer_cards)
